    ...
    if (!hash_equals($_SESSION['csrf'], (string) ($_POST['csrf'] ?? ''))) {
        ...
        if ($acao === 'excluir') {
            ...
            if (!$nome) {
                ...
                $m->atualizar((int) $_POST['id'], $nome, $desc);
                $msg = 'Categoria atualizada.';
            } else {
                $m->cadastrar($nome, $desc);
    ...
    <div class="card-body">
        <form method="POST" class="row g-2">
            ...
            <div class="col-md-5">
                ...
                <input name="descricao" class="form-control" value="<?= htmlspecialchars($edit['descricao'] ?? '') ?>">
            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-1">
                            <a href="categorias.php?editar=<?= $c['id'] ?>" class="btn btn-sm btn-warning">
                                Editar
                            </a>
