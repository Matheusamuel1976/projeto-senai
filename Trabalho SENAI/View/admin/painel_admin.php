...
<nav class="navbar navbar-dark navbar-logistica px-3">
    <a class="navbar-brand" href="painel_admin.php">
        <i class="bi bi-shield-lock"></i> LogiControl Admin
    </a>
    ...
    <div class="row">
        ...
        <div class="col-md-2 sidebar p-3">
            <nav class="nav flex-column">
                <a class="nav-link active" href="painel_admin.php">
                    <i class="bi bi-speedometer2"></i> Dashboard Admin
                </a>

                <a class="nav-link" href="../dashboard.php">
                    <i class="bi bi-house"></i> Dashboard Geral
                </a>
                ...
                <a class="nav-link" href="../entregas.php">
                    <i class="bi bi-geo-alt"></i> Entregas
                </a>
            </nav>
        </div>
        ...
        <div class="col-md-10 p-4">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-2">
                    <div class="card card-stat shadow-sm p-3">
                        ...
                        <div class="fs-4 fw-bold"><?= $totCli ?></div>
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="card card-stat shadow-sm p-3">
                        ...
                        <div class="fs-4 fw-bold"><?= $totForn ?></div>
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="card card-stat shadow-sm p-3">
                        ...
                        <div class="fs-4 fw-bold"><?= $totUsers ?></div>
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="card card-stat shadow-sm p-3">
                        ...
                        <div class="fs-4 fw-bold"><?= $pendentes ?></div>
                    </div>
                </div>

                <div class="col-md-2">
                    <div class="card card-stat shadow-sm p-3">
                        <div class="text-muted small">Em transporte</div>
                        <div class="fs-4 fw-bold"><?= $transito ?></div>
                    </div>
                </div>
            ...
            <div class="row g-3">
                                ...
                                <tbody>
                                    <?php foreach ($movs as $m): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge <?= $m['tipo'] === 'entrada' ? 'bg-success' : 'bg-warning text-dark' ?>">
                                                    <?= $m['tipo'] ?>
                                                </span>
                                            </td>
                                            <td><?= $m['quantidade'] ?></td>
                ...
                <div class="col-md-6">
                                ...
                                <tbody>
                                    <?php foreach ($usuarios as $u): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge <?= $u['tipo'] === 'admin' ? 'bg-dark' : 'bg-secondary' ?>">
                    ...
                    <a href="usuarios.php" class="btn btn-sm text-white mt-3" style="background:#0d3b66">
                        Gerenciar usuarios
                    </a>
