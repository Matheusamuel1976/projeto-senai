...
if (isset($_GET['editar'])) {
    $editando = $produtoModel->porId((int) $_GET['editar']);
}
...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="produtos.php" class="btn btn-sm text-white" style="background:#0d3b66">
        Novo produto
    </a>
</div>
    ...
    <div class="card-body">
        <form method="POST" class="row g-2">
            ...
            <div class="col-md-4">
                ...
                <input name="nome" class="form-control" required value="<?= htmlspecialchars($editando['nome'] ?? '') ?>">
            </div>
            ...
            <div class="col-md-4">
                ...
                <select name="categoria_id" class="form-select">
                    ...
                    <option value="<?= $c['id'] ?>" <?= isset($editando['categoria_id']) && $editando['categoria_id'] == $c['id'] ? 'selected' : '' ?>>
            ...
            <div class="col-md-4">
                ...
                <select name="fornecedor_id" class="form-select">
                    ...
                    <option value="<?= $f['id'] ?>" <?= isset($editando['fornecedor_id']) && $editando['fornecedor_id'] == $f['id'] ? 'selected' : '' ?>>
            ...
            <div class="col-md-3">
                ...
                <input type="number" step="0.01" name="preco" class="form-control" value="<?= htmlspecialchars($editando['preco'] ?? '0') ?>">
            </div>

            <div class="col-md-3">
                <label class="form-label">Quantidade</label>
                <input type="number" name="quantidade" class="form-control" value="<?= htmlspecialchars($editando['quantidade'] ?? '0') ?>">
            </div>

            <div class="col-md-3">
                <label class="form-label">Estoque minimo</label>
                <input type="number" name="estoque_minimo" class="form-control" value="<?= htmlspecialchars($editando['estoque_minimo'] ?? '5') ?>">
            </div>
            ...
            <div class="col-12">
                ...
                <input name="descricao" class="form-control" value="<?= htmlspecialchars($editando['descricao'] ?? '') ?>">
            </div>
        ...
        <table class="table table-striped mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="badge <?= $p['quantidade'] <= $p['estoque_minimo'] ? 'bg-danger' : 'bg-success' ?>">
                            <?= $p['quantidade'] ?>
                        </span>
                    </td>
                    ...
                    <td>
                        <div class="d-flex gap-1">
                            <a href="produtos.php?editar=<?= $p['id'] ?>" class="btn btn-sm btn-warning">
                                Editar
                            </a>
